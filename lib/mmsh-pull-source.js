...
exports.MMSHPullSourceAttempt = function(http_params) {
	...
	http_client.on("error", this.onError.bind(this));
	
	var req = http_client.request('GET', path, http_params);
...
module.exports.MMSHPullSource = function(http_params) {
	...
	attempt.once("done", function() {
	    ...
	    log.warn(c, "Stream ended or not connectable.  Waiting 10 seconds to attempt to reengage.");
	    setTimeout(this.startNewAttempt.bind(this), 10000);
	}.bind(this));
    };
