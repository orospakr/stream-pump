...
var MMSDemuxer = function(stream, packetHandler, errorHandler) {
	...
	if(this.fields_parsed === 0) {
	    ...
	    switch(field) {
	    case 0x44: // $D
		Tipe = mms_packet.DataPacket;
		break;
	    case 0x43: // $C
		Tipe = mms_packet.StreamChangePacket;
		break;
	    case 0x45: // $E
		Tipe = mms_packet.EndOfStreamPacket;
		break;
	    case 0x48:
		Tipe = mms_packet.HeaderPacket;
		break;
	    case 0x4D:
		Tipe = mms_packet.MetadataPacket;
		break;
	    default:
