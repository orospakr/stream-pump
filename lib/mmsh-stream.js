...
module.exports.MMSHStream = function(strm, includes_preheaders) {
	...
	if(packet.name === "Header") {
	    ...
	    // log.debug(c, "Header has been received: " + util.inspect(packet.payload.slice(0, 32)));
	    this.header = packet;
	    ...
	    log.warn(c, "I need to repack a packet type that I don't know how to repack yet for: " + packet.name);
	}
