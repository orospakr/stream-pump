...
var mms_client_session = require('./mms-client-session');
...
exports.MMSHandler = function() {
	...
	if(req.headers["content-type"] === "application/x-wms-pushsetup") {
	    ...
	    // TODO should receive a message here when MMStream has completed, so I can inform the clients that the stream has gone
		...
		if(client_id === undefined) {
		    var sess = new mms_client_session.MMSClientSession(this.stream, function(client_id) {
			return (!(client_id in this.sessions));
		    }.bind(this));
